                ...
                return (
                  <tr key={item.id} className="hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right space-x-1 whitespace-nowrap">
                      ...
                      <button
                        onClick={async () => {
                          if (confirm(`Tem a certeza que deseja excluir o item "${item.nome}"?`)) {
                            const res = await excluirProduto(item.id);
                            if (res.success) {
                              router.refresh();
                            } else {
                        ...
                        className="bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 px-2.5 py-1 rounded text-xs transition-all"
                      >
                        Excluir
                      </button>
                    </td>
